...
- [Visualiseringsbiblioteker](../research/LIBRARIES.md)
- [Plan for biblioteksforsøg](../research/PROOF-PLAN.md)
- [Prototypens resultater og begrænsninger](../research/PROTOTYPE-RESULTS.md)
- [Danske og grønlandske prøver sammenlignet](../research/EXAM-COMPARISON.md)
- [Danske FP9-kilder](../research/FP9-SOURCES.md)
- [Oversigt over lokale AEU-2-prøver](../research/FOUND-EXAMS.csv)
- [Materialer og lokale downloads](../materialer/README.md)

## Skærmbilleder

Fra prototypens browserafprøvning 9. september 2026:
